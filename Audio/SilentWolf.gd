...
const SWUtils = preload("res://Audio/utils/SWUtils.gd")
const SWHashing = preload("res://Audio/utils/SWHashing.gd")
const SWLogger = preload("res://Audio/utils/SWLogger.gd")
...
var config = {
	...
	"game_id": "theandrewtateinpossibleecape",
	"log_level": 0
}
